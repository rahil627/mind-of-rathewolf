...
layout: post
link: http://rahilpatel.com/blog/hypomania-and-creativity/
...
My work moved from medium to direct interaction, experiences. It supplied faster feedback, which was crucial as I worked alone. [Travel is the best way to consume the most amount of information, and a constant stream of performance-oriented events seemed the ideal way to create something based on that information](http://www.rahilpatel.com/blog/creativity-as-organization-from-chaos). [Humans of Taipei](https://www.facebook.com/TaiwanesePeople) and Vincent Moon documentary-like videos.
